                    ...
                    content: {
                        ...
                        text: function(event, api) {
                            ...
                            function parse_extensions(element) {
                                ...
                                text = text.split(",").map(function(string) {
                                    var obj = {};
                                    obj.id = utui.data.customizations[string.trimLeft()]._id;
                                    obj.text = obj.id + ": " + utui.data.customizations[string.trimLeft()].title;
                                    return obj;
                                });
        ...
        return (function() {
            ...
            csm.build_info_container = function(element) {
                ...
                if (new_elem.hasChildNodes()) {
                    let anchor = element.children[0].children[1].querySelector('.container_label');
